...
<body>
	<div class="container">
		<div class="row">
			...
			<div class="col-6">
				<form:form class="d-flex" action="/songs/search" method="GET" modelAttribute="findsong">
					<form:label path="artista" for="artist">Songs by artist:</form:label>
					<div class="form-group mx-sm-3 mb-2 col">
						<form:input path="artista" type="text" class="form-control" name="artist" id="artist"
							placeholder="Ej: Katy Perry" />
					</div>
				...
				<table class="table">
					...
					<tbody>
						<c:forEach items="${songs}" var="song">
							<tr>
								<td><a href="/song/view/${song.id}"><c:out value="${song.titulo}"></c:out></a></td>
